...
var NotificationsRepository = /** @class */ (function () {
    function NotificationsRepository(prisma) {
        this.prisma = prisma;
    }
    NotificationsRepository.prototype.create = function (createNotificationDTO) {
    ...
    NotificationsRepository.prototype.findNotificationsByUserId = function (findNotificationsByUserIdDTO, userId) {
        return __awaiter(this, void 0, Promise, function () {
            var page, pageSize, take, skip, notifications, totalCount, totalPages;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        page = findNotificationsByUserIdDTO.page, pageSize = findNotificationsByUserIdDTO.pageSize;
                        take = pageSize || 10;
    ...
    NotificationsRepository.prototype.setReadNotification = function (notificationId) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
